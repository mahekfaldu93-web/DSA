...
while (true)
{
  ...
  cout <<"Enter 3 to update an element from Array " <<endl;
 ...
 switch (choice)
 {
    case 1:
       ...
       if(pos>=0 && pos<num)
       {
         ...
         int posi;
         int el;
         cout << endl <<" enter the position of element you want to update :";
         cin>>posi;
